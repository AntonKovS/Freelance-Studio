...
module.exports = {
    ...
    mode: 'development',
    output: {
        filename: 'app.js',     //файл, который будет генерироваться на выходе
    ...
    plugins: [
        ...
        new CopyPlugin({
            patterns: [
                ...
                {from: "./node_modules/admin-lte/plugins/jquery/jquery.min.js", to: "js"},  //вроде должна быть на строчку выше
                ...
                {from: "./node_modules/admin-lte/plugins/moment/locale/ru.js", to: "js/moment-ru-locale.js"},   //при копировании изменяем имя файла
                ...
                {from: "./node_modules/admin-lte/plugins/fullcalendar/main.js", to: "js/fullcalendar.js"},   //при копировании изменяем имя файла
